...
ActiveRecord::Schema.define(version: 2021_05_08_230606) do
  ...
  create_table "destinations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_log_id"], name: "index_destinations_on_purchase_log_id"
  end
  ...
  add_foreign_key "destinations", "purchase_logs"
